...
namespace namegen.Controllers
{
    ...
    public class NameController : ControllerBase
    {
        ...
        const int leftLength = 100;
        const int rightLength = 234;

        private static readonly string[] leftSide = new[] {
    "admiring",
    "adoring",
    "affectionate",
    "agitated",
    ...
    "zealous",
    "zen"};
        private static readonly string[] rightSide = new[] {
    ...
    "zhukovsky"};
        ...
        public String Get()
        {
            string name = leftSide[random.Next(leftLength)] + "_" + rightSide[random.Next(rightLength)];
            return name;
        }
    }
}
